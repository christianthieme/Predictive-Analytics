...
download.file(
    url='https://raw.githubusercontent.com/SubhalaxmiRout002/DATA624/main/Project2/Screen%20Shot%202021-07-14%20at%203.06.44%20PM.png',
    destfile='image1.png',
    mode='wb')
...
```{r, echo=FALSE}
download.file(
    url='https://raw.githubusercontent.com/SubhalaxmiRout002/DATA624/main/Project2/Screen%20Shot%202021-07-14%20at%203.07.00%20PM.png',
    destfile='image2.png',
    mode='wb')
...
Based on the model results above, we have chosen the Cubist model as our final model. The cubist model has the lowest RMSE and MAE values as well as the highest $R^2$ values. 
...
Now that we've determined our top performing model, we'll use this model to predict on our test set. Before making predictions, we'll need to perform the same data processing steps as we have done with our training dataset. 
